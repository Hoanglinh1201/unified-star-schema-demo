...
orders as (
    ...
    select
        ...
        null as _key_seller_geo_id,
        customer_id as _key_customer_id,
        null as _key_customer_geo_id,
...
customers as (
    select
        ...
        null as _key_seller_geo_id,
        customer_id as _key_customer_id,
        geolocation_id as _key_customer_geo_id,
...
sellers as (
    select
        ...
        geolocation_id as _key_seller_geo_id,
...
select * from users
union
select * from seller_geolocations
union
select * from customer_geolocations
